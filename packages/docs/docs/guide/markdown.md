...
- [kdu-js.web.app](https://kdu-js.web.app)
- [KduPress on GitHub](https://github.com/kdujs/kdupress)
...
KduPress uses [Prism](https://prismjs.com/) to highlight language syntax in Markdown code blocks, using coloured text. Prism supports a wide variety of programming languages. All you need to do is append a valid language alias to the beginning backticks for the code block:
...
<<< @/../@kdupress/markdown/__tests__/fragments/snippet-with-region.js
...
KduPress uses [markdown-it](https://github.com/markdown-it/markdown-it) as the Markdown renderer. A lot of the extensions above are implemented via custom plugins. You can further customize the `markdown-it` instance using the `markdown` option in `.kdupress/config.js`:
