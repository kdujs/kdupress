...
Starting with KduPress 1.x.x, KduPress provides an `AppContext` object that stores all the state of the current app and can be accessed through the plugin API.
...
Whether KduPress run in production environment mode.
