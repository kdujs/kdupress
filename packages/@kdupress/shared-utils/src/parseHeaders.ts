...
// Since KduPress needs to extract the header from the markdown source
...
// HTML in headers, so in KduPress, after being parsed by the markdown
// loader, the raw HTML in headers will finally be parsed by Kdu-loader.
// so that we can write HTML/Kdu in the header. One exception is the HTML
