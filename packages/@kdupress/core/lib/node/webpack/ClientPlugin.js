...
var KduSSRClientPlugin = function KduSSRClientPlugin (options) {
  if (options === void 0) options = {}

  this.options = Object.assign({
    filename: 'kdu-ssr-client-manifest.json'
  }, options)
}

KduSSRClientPlugin.prototype.apply = function apply (compiler) {
  var this$1 = this

  onEmit(compiler, 'kdu-client-plugin', function (compilation, cb) {
...
module.exports = KduSSRClientPlugin
