...
const {
  ...
  extractHeaders,
  parseFrontmatter,
  parseKduFrontmatter: { parse: parseKduFrontmatter }
...
module.exports = class Page {
  ...
  constructor ({
    ...
    this.key = 'k-' + hash(`${this._filePath}${this.regularPath}`)
  ...
  async process ({
    ...
    if (this._content) {
      ...
      } else if (this._filePath.endsWith('.kdu')) {
        const { data = {}} = parseKduFrontmatter(this._content)
        // When Kdu SFCs are source files, make them as layout components directly.
