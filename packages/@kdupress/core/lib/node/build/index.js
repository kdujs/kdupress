...
const { chalk, fs, path, logger, env, performance } = require('@kdupress/shared-utils')
...
module.exports = class Build extends EventEmitter {
  ...
  async render () {
    ...
    logger.developer(`It took a total of ${chalk.cyan(`${duration}ms`)} to run the ${chalk.cyan('kdupress build')}.`)
    console.log()
  }
