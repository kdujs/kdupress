...
module.exports = function loadConfig (kdupressDir, bustCache = true) {
  const configPath = path.resolve(kdupressDir, 'config.js')
  const configYmlPath = path.resolve(kdupressDir, 'config.yml')
  const configTomlPath = path.resolve(kdupressDir, 'config.toml')
